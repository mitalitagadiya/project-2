                        ...
                        <div className="col-lg-4">
                            <div className="info">
                                <div className="address">
                                    ...
                                    <h4>Location:</h4> <p> F-505, Inovative Plazza New Delhi, India</p>
                                </div>
                                <div className="email">
                                    <i className="bi bi-envelope" />
                                    <h4>Email:</h4> <p>cityhospital@example.com</p>
                                </div>
                                <div className="phone">
                                    <i className="bi bi-phone" />
                                    <h4>Call:</h4> <p>+91 9988776655</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <Formik values={formik}>
                                <Form onSubmit={handleSubmit} action method="post" role="form" className="php-email-form">
                                    ...
                                    <div className="form-group mt-3">
                                        <input onChange={handleChange} onBlur={handleBlur} type="text" className="form-control" name="subject"  id="subject" placeholder="Subject"/>
                                        <p className='text-color'>
